...
print("=" * 80)
print("AIRCRAFT CORROSION PREDICTION MODEL V2 - ENHANCED FEATURES")
print("=" * 80)
...
test_results.to_csv('Model_2/test_predictions.csv', index=False)
print(f"  ✓ Test predictions saved to: Model_2/test_predictions.csv")
...
summary_df.to_csv('Model_2/model_performance_summary.csv', index=False)
print(f"  ✓ Performance summary saved to: Model_2/model_performance_summary.csv")

importance_df.to_csv('Model_2/feature_importance.csv', index=False)
print(f"  ✓ Feature importance saved to: Model_2/feature_importance.csv")

# ============================================================================
# 10. COMPARISON WITH MODEL 1
# ============================================================================
print("\n" + "=" * 80)
print("COMPARISON WITH MODEL 1")
print("=" * 80)
print(f"\nModel 1 (331 features):")
print(f"  - Test Brier Score: 0.100244")
print(f"  - Test AUC-ROC: 0.9236")
print(f"\nModel 2 ({X.shape[1]:,} features):")
print(f"  - Test Brier Score: {test_brier:.6f}")
print(f"  - Test AUC-ROC: {test_auc:.4f}")
print(f"\nImprovement:")
brier_improvement = ((0.100244 - test_brier) / 0.100244) * 100
auc_improvement = ((test_auc - 0.9236) / 0.9236) * 100
print(f"  - Brier Score: {brier_improvement:+.2f}% {'(better)' if brier_improvement > 0 else '(worse)'}")
print(f"  - AUC-ROC: {auc_improvement:+.2f}% {'(better)' if auc_improvement > 0 else '(worse)'}")

print("\n" + "=" * 80)
print("EXECUTION SUMMARY")
print("=" * 80)
print(f"\n✓ Model V2 successfully trained and evaluated")
print(f"✓ Test set Brier Score: {test_brier:.6f}")
print(f"✓ Test set AUC-ROC: {test_auc:.4f}")
print(f"✓ Total features: {X.shape[1]:,}")
print(f"✓ Results saved to Model_2/ directory")
